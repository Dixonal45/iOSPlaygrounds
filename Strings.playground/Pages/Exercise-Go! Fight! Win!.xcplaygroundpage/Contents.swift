...
let schoolName = "Ariana Academy"
let refrain = "crush, defeat, terminate the enemy! \(schoolName) always wins! \(schoolName) will rule the world, because we never sins!"

let song = "Go and \(refrain)\n Let's all \(refrain)\n Yes, \(refrain)"
