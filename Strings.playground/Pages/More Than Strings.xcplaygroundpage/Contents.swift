...
let job = "chef"
let food = "sushi"
let secondName = "Ariana"
let place = "Times Square"
let secondFood = "gnocci"
let storyString = "\(name) was the worst \(job) I had ever met. Her \(food) was the most disgusting \(food) I had even tasted. Even \(secondName)'s \(food) was better than hers. And that's saying something because one time \(secondName) almost burned \(place) down by leaving her \(secondFood) in the oven too long."
