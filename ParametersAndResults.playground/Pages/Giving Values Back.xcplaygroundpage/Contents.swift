...
let favoriteMovie = makeFavorite(categoryOfThing: "movie", favorite: "Inception")
let favoriteFood = makeFavorite(categoryOfThing: "food", favorite: "chocolate")
...
"Hello, my name is Allison. \(favoriteMovie). \(favoriteFood)."
