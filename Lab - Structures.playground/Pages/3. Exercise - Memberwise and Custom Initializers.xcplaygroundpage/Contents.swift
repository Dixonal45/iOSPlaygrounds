...
favoriteBook.title = "Red Queen"
favoriteBook.author = "Liana Hill"
favoriteBook.pages = 425
favoriteBook.price = 14.25
print("My favorite book", favoriteBook.title, "is by", favoriteBook.author, "and has", favoriteBook.pages, "pages, and costs $",favoriteBook.price)
...
var myHeightInches = Height(heightInCentimeters: 177.8)
print(myHeightInches.heightInInches)
