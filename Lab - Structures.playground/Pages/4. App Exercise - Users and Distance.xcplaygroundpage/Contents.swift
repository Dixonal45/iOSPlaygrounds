 ...
 */
var Allison = User(name: "Allison", age: 16, height: 70.0, weight: 150, activityLevel: 7)
print("Hi my name is \(Allison.name) and I am \(Allison.age) years old. I am \(Allison.height) inches tall and weigh \(Allison.weight) pounds. My activity level is \(Allison.activityLevel).")
/*:
